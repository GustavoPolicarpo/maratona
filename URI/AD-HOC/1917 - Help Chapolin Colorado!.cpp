...
// Level: 8
// Category: AD-HOC
// URL: https://www.beecrowd.com.br/judge/en/problems/view/1917
...
int main()
{
	...
	identidade.mat[0][0]=Integer("1"), identidade.mat[0][1]=Integer("0");
    identidade.mat[1][0]=Integer("0"), identidade.mat[1][1]=Integer("1");
    int X, MF;
    while(scanf("%d %d", &X, &MF) and X){
    	Matriz fib;
    	fib.mat[0][0]=Integer("1"), fib.mat[0][1]=Integer("1");
    	fib.mat[1][0]=Integer("1"), fib.mat[1][1]=Integer("0");
    	fib=fastExp(fib, MF+1);
    	BigInt out = (fib.mat[0][0]);
    	Print(out*X);
	}
return 0;
}
